...
class StoreExternalUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email'          => 'required|email|max:150|unique:usuarios_externos,email',
            'curp'           => 'nullable|string|size:18|unique:usuarios_externos,curp|regex:/^[A-Z]{4}[0-9]{6}[HM][A-Z]{5}[0-9A-Z]{2}$/',
