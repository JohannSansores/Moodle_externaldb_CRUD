...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col">
            ...
            <!-- Footer global sin bordes blancos -->
            <footer style="margin-top: auto; bg:white dark:bg-gray-800;">
                <div style="background:#002e5f;  padding:20px 30px 20px; color:white; width:100%; box-sizing:border-box; font-family:Arial,sans-serif; overflow:hidden;">
